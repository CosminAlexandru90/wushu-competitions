...
import {LuArchive, LuDog, LuLogOut, LuNotebookPen, LuSchool, LuShirt} from "react-icons/lu";
    ...
    return (
      <nav className={'flex flex-col justify-between p-8 w-80 bg-sky-950/30 rounded-xl my-2'}>
          <ol className={'flex flex-col gap-3'}>
              ...
              <li><a href="/athlete" className={'text-3xl flex flex-row gap-2 items-center'}><LuShirt />Athletes</a></li>
              <li><a href="/course"  className={'text-3xl flex flex-row gap-2 items-center'}><LuDog />Courses</a></li>
              <li><a href="/club"  className={'text-3xl flex flex-row gap-2 items-center'}><LuSchool />Club</a></li>
          </ol>
